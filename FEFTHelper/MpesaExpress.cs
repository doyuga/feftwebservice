...
namespace FEFTHelper
{
    public class MpesaExpress
    {
            ...
            try
            {
                ...
                //request.AddHeader("Authorization", "Bearer Uv30IQ1XMzRxGtCgLBkLFAjSXMJy");
                //request.AddParameter("BusinessShortCode", "174379");
                //request.AddParameter("Password", "MTc0Mzc5YmZiMjc5ZjlhYTliZGJjZjE1OGU5N2RkNzFhNDY3Y2QyZTBjODkzMDU5YjEwZjc4ZTZiNzJhZGExZWQyYzkxOTIwMjExMTA3MjMwMzE4");
                //request.AddParameter("Timestamp", "20211107230318");
                //request.AddParameter("TransactionType", "CustomerPayBillOnline");
                //request.AddParameter("Amount", 1);
                //request.AddParameter("PartyA", 254708374149);
                //request.AddParameter("PartyB", 174379);
                //request.AddParameter("PhoneNumber", 254708374149);
                //request.AddParameter("CallBackURL", "https://endpoint.feftportal.co.ke/feftpayment");
                //request.AddParameter("AccountReference", "CompanyXLTD");
                //request.AddParameter("TransactionDesc", "Payment of X");
                ...
                string passkey= "6SYBl2UK7st4jMMO8SGDA65i1aAnNLjD";
                string ShortCode = "7249428";
                string plainText = passkey+ShortCode + timestamp;
                var plainTextBytes = Encoding.UTF8.GetBytes(plainText);
                string encodedText = Convert.ToBase64String(plainTextBytes);
                //var decmessage = Convert.FromBase64String(encodedText);
                string phonenumber = "254729566878";

                var httpWebRequest = (HttpWebRequest)WebRequest.Create("https://api.safaricom.co.ke/mpesa/stkpush/v1/processrequest");
                httpWebRequest.ContentType = "application/json";
                httpWebRequest.Method = "POST";
                httpWebRequest.Headers.Add("Authorization", "Basic NlNZQmwyVUs3c3Q0ak1NTzhTR0RBNjVpMWFBbk5MakQ6TTF1bkFsVGlYeElXWXpLeg==");
                using (var streamWriter = new StreamWriter(httpWebRequest.GetRequestStream()))
                {
                    string json = "{" +
                        ...
                        "\"CallBackURL\":\"" + "https://rubis.feftportal.co.ke/feftpayment" + "\"," +
                        "\"AccountReference\":\"" + "Mpesa Langata" + "\"," +
                        "\"TransactionDesc\":\"" + "Payment for Langata" + "\"," +
                        "}";
